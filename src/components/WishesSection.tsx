  ...
  return (
    <div className="absolute bottom-0 left-0 w-full pointer-events-none" aria-hidden="true">
      <svg viewBox="0 0 800 120" preserveAspectRatio="none" className="w-full h-24">
        <path d="M0,80 Q200,20 400,80 Q600,140 800,80 L800,120 L0,120Z" fill="#FFB7C5" opacity="0.15" />
        <path d="M0,90 Q150,50 350,90 Q550,130 800,90 L800,120 L0,120Z" fill="#FFDAC1" opacity="0.15" />
      </svg>
      {[10, 25, 50, 70, 85].map((left, i) => (
        ...
        >
          <svg width="16" height="40" viewBox="0 0 16 40">
            <line x1="8" y1="40" x2="8" y2="12" stroke="#c08080" strokeWidth="1.5" />
    ...
    <div className="absolute inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
      {Array.from({ length: 6 }).map((_, i) => (
        <svg
          ...
          style={{ left: `${10 + i * 15}%`, top: `${15 + (i % 3) * 25}%`, animationDelay: `${i * 0.6}s`, opacity: 0.12 }}
          width="18" height="18" viewBox="0 0 24 24" fill="#FFB7C5"
        >
          <path d="M12,21 C12,21 3,13 3,8 A5,5,0,0,1,12,5 A5,5,0,0,1,21,8 C21,13 12,21 12,21Z" />
        </svg>
      ))}
...
export default function WishesSection() {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    confetti({
      ...
      particleCount: 150,
      origin: { y: 0.4 },
      colors: ['#FFB7C5', '#FFDAC1', '#C7CEEA', '#FFD700'],
    });
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-secondary text-sm">
            Berikan ucapan selamat dan doa terbaik untuk Rumaisha Qonita
          </p>
        </motion.div>
          ...
          <div className="flex flex-col gap-5">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Tulis ucapan atau doa untuk Rumaisha Qonita..."
                rows={4}
        ...
        {loadingWishes ? (
          ...
          <motion.div className="text-center py-10" initial={prefersReduced ? {} : { opacity: 0 }} animate={{ opacity: 1 }}>
            <svg width="36" height="36" viewBox="0 0 24 24" fill="#e9c349" fillOpacity="0.5" className="mx-auto mb-3 animate-twinkle motion-reduce:animate-none">
              <polygon points="12,2 15,10 24,10 17,15 19,24 12,19 5,24 7,15 0,10 9,10" />
            </svg>
